...
while True:
    ...
    if nivel_gas > 2500:
        ...
        print("🚨 ALERTA DE GAS DETECTADO!")
        print("📧 Solicitacao de envio de email enviada ao Node-RED")
    ...
    if alerta_gas == "ALERTA GAS":
        print("📨 MQTT publicou alerta para envio de email")

    # =========================
    # GOOGLE SHEETS
    # =========================

    dados_registro = "{},{},{},{},{},{}".format(
        temperatura,
        umidade,
        luminosidade,
        nivel_gas,
    ...
    oled.text(
        "Gas:{}".format(nivel_gas),
        0,
        30
    )

    oled.text(
        "Porta:{}".format(status_porta),
        0,
        40
    )
